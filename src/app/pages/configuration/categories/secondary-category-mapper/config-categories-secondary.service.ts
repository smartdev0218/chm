...
@Injectable()
export class ConfigCategoriesSecondaryService  extends ChmHttp {
    ...
    getParentChannelCategories(idChannel) {
        return <Observable<any>>this.http
            .get(this.store.getSitesUrl() + "/secondary-categories/channel/" + idChannel)
            .map(res => this.extractData(res))
            .catch(this.handleError);
    }
    ...
    getMappedCategoriesByChannel(idChannel) {
        return <Observable<any>>this.http
            .get(this.store.getSitesUrl() + "/secondary-categories/channel/" + idChannel + "/mappings")
            .map(res => this.extractData(res))
            .catch(this.handleError);
    }
    ...
    mapCategory(idChannel, idCategoryChannel, idCategoryHermes) {
        return <Observable<any>>this.http
            .post(this.store.getSitesUrl() + "/secondary-categories/channel/" + idChannel+'?hermes-category-id='+idCategoryHermes+'&channel-category-id='+idCategoryChannel, '')
            .map(res => this.extractData(res))
            .catch(this.handleError);
    }    
    ...
    unmapCategory(idChannel, idCategoryChannel, idCategoryHermes) {
        return <Observable<any>>this.http
            .delete(this.store.getSitesUrl() + "/secondary-categories/channel/" + idChannel+'?hermes-category-id='+idCategoryHermes+'&channel-category-id='+idCategoryChannel)
            .map(res => this.extractData(res))
            .catch(this.handleError);
    }
